...
public class TesteListas {
    ...
    public static void main(String[] args) {
        ...
        tempoArrayList = getElementoN(numerosArrayList, 10000000 / 2);
        tempoLinkedList = getElementoN(numerosLinkedList, 10000000 / 2);

        System.out.println("getElementoN da ArrayList demorou  " + tempoArrayList);
        System.out.println("getElementoN da LinkedList demorou " + tempoLinkedList);
    }
    ...
    private static long getElementoN(List<Integer> numeros, int n) {
        long ini = System.currentTimeMillis();
        numeros.get(n);
        long fim = System.currentTimeMillis();
        return fim - ini;
